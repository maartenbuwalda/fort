  ...
  render() {
    return (
      <div className='wrapper'>
        ...
        <p>Voor bedrijven en gemeentelijke instellingen waarbij samenwerking en teamwork van essentieel belang is.</p>

        <h2>Cursusduur</h2>
        <p>De basis cursus bestaat uit twee bijeenkomsten van een dag (09:00-16:00) met minimaal een week tussenruimte, inclusief “huiswerk”. De cursus wordt gegeven op Fort Penningsveer 2, 2065 AM Haarlemmerliede</p>

        <h2>Cursusleiding</h2>
        <p>De cursussen zullen gegeven worden door gecertificeerde trainers van het Korps Mariniers.</p>

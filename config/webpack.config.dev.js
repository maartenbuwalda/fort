  ...
  module: {
    ...
    loaders: [
      // Process JS with Babel.
      {
        test: /\.js$/,
        include: paths.appSrc,
        loaders: ['react-hot', 'babel?presets[]=es2015,presets[]=es2016,presets[]=stage-0,presets[]=react,plugins[]=transform-runtime'],
      ...
      // in development "style" loader enables hot editing of CSS.
      {
        ...
        loader: 'style!css?modules&localIdentName=[local]!postcss!sass?indentedSyntax'
      },
      // {
      //   test: /\.css$/,
      //   include: [paths.appSrc, paths.appNodeModules],
